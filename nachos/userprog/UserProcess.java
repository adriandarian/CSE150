...
public class UserProcess {
  ...
  private int handleJoin(int pid, int statusAddress) {
    ...
    /*
     * byte closeArray[] = new byte[4]; Lib.bytesFromInt(stat, 0, child.status); int
     * writtenBytes = writeVirtualMemory(statusAddress, stat); return
     * (child.goodExit && writtenBytes == 4) ? 1 : 0;
     * 
     * if (pid < 0 || statusAddress < 0) { return -1; }
     */
