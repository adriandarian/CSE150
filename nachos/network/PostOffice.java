...
public class PostOffice {
  /**
   * Allocate a new post office, using an array of <tt>SynchList</tt>s. Register
   * the interrupt handlers with the network hardware and start the "postal
   * worker" thread.
   */
  public PostOffice() {
  ...
  /**
   * Called when a packet has been sent and another can be queued to the network
   * link. Note that this is called even if the previous packet was dropped.
   */
